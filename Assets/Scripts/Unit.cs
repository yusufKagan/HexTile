...
public class Unit : MonoBehaviour
{
    ...
    [SerializeField]
    private float movementDuration = 1f, rotationDuration = 0.3f;
    private GlowLight glowHighlight;
    private Queue<Vector3> pathPositions = new Queue<Vector3>();
    public event Action<Unit> MovementFinished;
    private void Awake()
    {
        glowHighlight = GetComponent<GlowLight>();
    }
    ...
    public void MoveThrouhPath(List<Vector3> currentPath)
    {
